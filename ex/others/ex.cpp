...
Mat seam_carving(const Mat &imcol, Mat &imgray, int m_neu, int n_new);
...
int main( int argc, char** argv )
{
    ...
    Mat original_image;
    Mat im_gray;
    original_image = imread("Camera_obscura.jpg", 1 );
    im_gray = imread("Camera_obscura.jpg", 0 );
    ...
    m=im_gray.rows;
    n=im_gray.cols;
    Mat final_result=seam_carving(original_image, im_gray, m-70, n-80);
